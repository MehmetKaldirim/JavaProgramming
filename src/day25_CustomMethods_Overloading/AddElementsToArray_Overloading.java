...
public class AddElementsToArray_Overloading {
        ...
        public static void main(String[] args) {
            ...
            printElement(names); //print element of array
    ...
    //3. create a return method called addString that can add a String after the last index of a String array
    public static String[] addElement(String e,String... element){
        ...
        result[result.length-1] = e; // element need to be assigned to the last index
        // result[i] = element;
