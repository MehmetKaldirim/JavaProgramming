...
public class EmployeeObjects {
    ...
    public static void main(String[] args) {
        ...
        //Person person = new Person("Josh", 35, 'M'); // It is an abstract class
        //Employee employee = new Employee("Ali",30,'M',42,"SDET",145000.00); // abstract class can not ınstantiate
